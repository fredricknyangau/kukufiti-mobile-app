...
import 'package:mobile/shared/widgets/update_dialog.dart';
          ...
          child: Padding(
            ...
            child: Row(
              children: [
                ...
                if (!isPremium)
                  Icon(LucideIcons.lock, size: 16, color: customColors.neutral!) // Safe: defined in CustomColors
                else
                  Icon(LucideIcons.chevronRight, color: customColors.neutral!), // Safe: defined in CustomColors
              ],
            ),
          ),
        ),
