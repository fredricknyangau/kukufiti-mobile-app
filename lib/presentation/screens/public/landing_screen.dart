                  ...
                  child: Column(
                    children: [
                      _buildGlassFeatureCard(
                        context,
                        'Financial Tracking',
                        'Track every shilling. Costs, sales, and profit margin analysis per batch.',
                      ...
                      _buildGlassFeatureCard(
                        ...
                        'Identify health issues early with real-time rate tracking and alerts.',
                      ...
                      _buildGlassFeatureCard(
                        context,
                        'Performance Metrics',
                        'Compare FCR across batches to optimize your feeding strategy.',
                      ...
                      _buildGlassFeatureCard(
                        context,
                        'Biosecurity Logs',
                        'Maintain digital records of all biosecurity checks for flock safety.',
                      ...
                      _buildGlassFeatureCard(
                        context,
                        'Real-time Updates',
                        'Access your farm data from anywhere. Your farm fits in your pocket.',
                        LucideIcons.clock,
                        theme,
                      ),
                      const SizedBox(height: 16),
                      _buildGlassFeatureCard(
                        context,
                        'Task Management',
                        'Never miss a vaccination or feed schedule with integrated tracking.',
